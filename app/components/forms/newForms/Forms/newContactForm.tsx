			...
			<div className="flex flex-col mt-10 col-span-full gap-x-6 gap-y-8 ">
				...
				<div className="relative sm:col-span-2">
					...
					<div className="relative mt-2.5">
						...
						<input
							...
							onChange={(e) => {
								const formattedNumber = formatPhoneNo(
									e.target.value
								)
								setFormData({
									...formData,
				...
				<div className="flex flex-col items-start mx-2 text-xl align-middle ">
					...
					<p className="text-lg text-gray-500 ">
						Subscribe for future giveaways, product launches and
						programs alerts?{" "}
						<span className="text-zinc-400">
							(Subscribing will also create an account where you
							can supply any verification documents in the event
						...
						<div className="mx-6 space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
							<div className="flex items-center">
								<label
									...
									/>
									<p className="block ml-3 font-medium leading-6 text-gray-900 cursor-pointer">
										No
									</p>
								</label>
							</div>
