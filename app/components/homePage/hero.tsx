...
import ebtTealCard from "@images/ebtTeal.png"
import androidPhone from "@images/androidPhone.png"
...
const Hero = ({ toggleMainForm, formOpen, form, setForm }: hero) => {
	return (
		<section
			id="hero"
			className={`${
				formOpen === true && "overflow-hidden"
			} relative px-4 mx-auto max-w-7xl sm:mt-12`}>
			{/* {formOpen && <SignupForm toggleMainForm={toggleMainForm} formOpen={formOpen} />} */}
			{formOpen && form === "NewApplicationForm" && (
				<PopupModal
