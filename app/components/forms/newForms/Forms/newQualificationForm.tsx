				...
				<div className="pt-6 col-span-full">
					...
					<fieldset className="mt-4">
						<legend className="sr-only">
							Benefits you would like to submit for eligibility
						</legend>
						<div className="space-y-2">
							...
							<label
								...
								className={`${
									"SNAP" === formData.qualification
										? "ring-2 ring-[#07B6D4]"
										: "hover:ring-2 hover:ring-[#8FCAD4] active:ring-[#07B6D4]"
								...
								/>
								<p className="block ml-3 text-base font-medium leading-6 text-gray-700 cursor-pointer ">
									SNAP
								</p>
							</label>
							{/*  */}
							...
							<label
								...
								className={`${
									"Medicaid" === formData.qualification
										? "ring-2 ring-[#07B6D4]"
										: "hover:ring-2 hover:ring-[#8FCAD4] active:ring-[#07B6D4]"
								} flex items-center px-4 py-2 max-w-md border rounded-lg cursor-pointer border-zinc-300 `}>
								<input
							...
							<label
								...
								className={`${
									"Pell Grant" === formData.qualification
										? "ring-2 ring-[#07B6D4]"
										: "hover:ring-2 hover:ring-[#8FCAD4] active:ring-[#07B6D4]"
								} flex items-center px-4 py-2 max-w-md border rounded-lg cursor-pointer border-zinc-300 `}>
								<input
							...
							<label
								...
								className={`${
									"Section 8" === formData.qualification
										? "ring-2 ring-[#07B6D4]"
										: "hover:ring-2 hover:ring-[#8FCAD4] active:ring-[#07B6D4]"
								} flex items-center px-4 py-2 max-w-md border rounded-lg cursor-pointer border-zinc-300 `}>
								<input
							...
							<TooltipProvider>
								<Tooltip>
									...
									<TooltipContent className="text-white rounded-lg bg-zinc-700 max-w-[520px]">
										<h4 className="my-2 text-lg font-bold max-w-[300px]">
											{" "}
											Why is this being asked for?
										</h4>
										<p className="max-w-[300px] text-base text-zinc-200">
											Affordable Connectivity Program
											(ACP) is seeking to identify and
											confirm that the information you
											provide is truely yours and that it
											matches your eligibility claim.
										</p>
									</TooltipContent>
								</Tooltip>
							</TooltipProvider>
						...
						<div className="relative">
							<TextInput
								...
								onChange={(
									...
									const numOnly = e.target.value.replace(
										/[^0-9]/g,
										""
									)
									setFormData({
