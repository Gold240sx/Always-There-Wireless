...
const BgPattern = () => {
	return (
		<div
			className="hidden w-full h-full pointer-events-none -z-20 sm:absolute top:0 sm:inset-y-0 sm:block"
			aria-hidden="true">
			<div className="relative w-full h-full mx-auto overflow-x-hidden -transform-h-full">
				...
				<svg
					className="absolute bg-repeat-y left-full -translate-x-1/4"
					width={404}
					height={984}
					fill="none"
					viewBox="0 0 404 784">
