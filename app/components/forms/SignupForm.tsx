		...
		<Card className="w-full h-full">
			<CardHeader className="relative w-full py-12">
				...
				<CardDescription className="text-lg text-center max-w-4/5 max-w-2/3">
					Complete this form to apply for one of our
					government-sponsored phone + tablet discounts to get your
					phone or tablet for as little as $20.{" "}
				</CardDescription>
			</CardHeader>
			...
			<CardFooter className="items-center w-full px-12 pt-6 pb-8 -mb-10 text-lg text-center min-h-24 text-zinc-600 bg-zinc-200">
				<p className="max-w-3/5">
					Offer subject to availability. By submitting this form you
					hereby aknowledge that the information that you submit is
					your own, current and valid. Address must be located within
					the greater US and applicants must be of age 18yo or older.
					Eligibility is determined by the government program and is
					not controlled by us in any way. We do not gurantee
					eligibility or product availibility. We will not be held
					liable in any way for the misuse of any products aquired via
					this program.
				</p>
			</CardFooter>
		</Card>
