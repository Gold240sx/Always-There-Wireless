...
import { type Product } from "@forms/FormSupport"
			...
			<div
				...
				<div
					...
					<div className="flex gap-1">
						...
						<div className="pl-2">
							<h4 className=" font-bold text-[#4f9caa]">
								{name}
							</h4>
					...
					<div className="w-full px-6">
						{cardEpanded && (
							<div className="w-full pb-4 h-fit bg-zinc-200/50 rounded-xl min-h-24">
								<h2 className="p-2 font-bold text-zinc-500 ">
									Product Details
								</h2>
								<ul className="pt-2 pl-4 text-lg text-[#47919e] ">
									<li>
										<span className="pr-2 font-bold text-zinc-500">
											Brand:
										</span>
										{brand}
									</li>
				...
				<div
					...
					<div
						...
						<ChevronDownIcon
							className="w-3/4 m-auto text-gray-400 pointer-events-none "
							aria-hidden="true"
						/>
					</div>
				</div>
