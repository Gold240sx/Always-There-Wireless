...
import { valueToDropdownConversion, states } from "../newAppSchema"
...
const UserForm = ({
	...
	useEffect(() => {
		...
		unregister,
		docDifDelivCheck,
		formData.address.docDifDelivAdd,
	])
			...
			<div className="grid grid-cols-12 mt-10 gap-x-6 gap-y-8">
				...
				<div className="col-span-full sm:col-span-3 lg:col-span-2 ">
					<div className="flex justify-between px-1">
						...
						/>
						<span
							className="text-sm leading-6 text-gray-500 opacity-0 md:opacity-100"
							id="state-required">
							Required
						</span>
					</div>
				...
				{docDifDelivCheck === "true" && (
					<>
						<div className="col-span-full">
							...
							<p className="mt-1 text-sm leading-6 text-gray-600 col-span-full">
								Provide the address where we should ship your
								items to.
							</p>
						</div>
						{/*  */}
							...
							<div className="mt-1">
								<div className="relative">
									<TextInput
										...
										{...register(
											"address.physical.addressLn1"
										)}
										value={
											formData.address.physical.addressLn1
										}
										onChange={(
