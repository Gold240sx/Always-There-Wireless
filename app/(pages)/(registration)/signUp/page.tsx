...
import { SignUp } from "@/app/firebase/authFunctions"
import Image from "next/image"
import SignInImage from "@images/signInImage.jpeg"
/* eslint-disable */
// functions I will add on later with additional application validation (required user codes to create account)
...
export default function SignUpPage() {
	...
	useEffect(() => {
		...
		if (localLoginDetails) {
			const { email: localEmail, remember: localRemember } =
				JSON.parse(localLoginDetails)
	...
	return (
		<>
			<div className="flex flex-1 min-h-full py-24 pt-36">
							...
							<div className="mt-10">
								<div className="relative">
									...
									<div className="relative flex justify-center text-sm font-medium leading-6">
										<span className="px-6 text-gray-900 bg-[#F1F2F3]">
											Or continue with
										</span>
									</div>
								</div>
